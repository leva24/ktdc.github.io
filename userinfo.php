...
<div style="background-color:#877D7D ; width:1355px; height:auto; margin-left:-30px ;">
	 <img src="images/goa-hotel-conference-room.jpg" alt="Amazing" width="708" height="153"/>
            <form name="form1" method ="POST" action="userdetailinsert.php">
  ...
  <tr><td><font color="#FFFFFF">Address</td><td> <textarea  id="dddd" name="addr" required> </textarea></td></tr>
  ...
  <tr><td><font color="#FFFFFF">Gender</td><td> <font color="#FFFFFF">male &nbsp; &nbsp; <input type="radio" name="gender" id="c" value="m" ><font color="#FFFFFF"> female  &nbsp; &nbsp; <input type="radio" name="gender" id="t"value="f"> </td></tr>
  
    
 <tr><td><font color="#FFFFFF">Username</td><td> <input type="text"  placeholder="logic" name="a2" id="d1"  required> </td></tr>

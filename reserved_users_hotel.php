...
$result=mysql_query($sql);
	...
	$hid=$row['hid'];
		...
		$sql="select * from  reservation where hid='$hid' ";
...
echo"<tr><td style=color:white>".$row['id']."</td>";
			...
			?>
			<td></td>
			<td  width="60"><a href="reserved_users_hotel.php?action=delete&id=<?php echo $id1; ?>&rooms=<?php echo $row['rooms'];?>&hid=<?php echo $row['hid']?> ">cancel</a></td>

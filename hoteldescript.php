...
<table align="center" style="position:relative; left:100px;">
                            <form action="hotel_descript_action.php" method="post" enctype="multipart/form-data">
                             ...
                             <tr>
                                ...
                                <hr>
                              <td></td><td><input type="submit" style="width:100px;height:30px;background-color:#996600 ;border-radius:10px;border:solid color: #3399FF;"  value="ADD"  onclick="return validate()" align="center"></td>
                              
                               <td><a style="background-color:#EB090D;color:#F5F2F2; size:10px;"href="hotel_edit.php">Edit Hotel details >></a></td>

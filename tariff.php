...
<?php
	include "header.php";
?>
<div style="background-color:#7D2800 ; width:1355px; height:auto; margin-left:-180px ">


<center><font color=skyblue size=4><b><i><u>TARIFF & POLICIES</u></i></b></font></center>
<br><br>
<?php
	...
	echo "<center>";
	echo "<table border=1>";
	echo "<caption><font color='yellow' size=4><b><i>ROOM TARIFF</i></b></font></caption>";
...
<tr>
	...
	<font color="#999933" size=4><li>POLICIES:</font>
	<ul type=disc><font color="#CCCCCC">
	...
	<br>
	<font color="#999933" size=4><li>RESERVATION GURANTEE :</font>
	<ul type=disc><font color="#CCCCCC">
		<li>All booking must be guaranteed at time of reservation bye money<br>
		order or travel agency.
	</ul>	
	<br>
	<font color="#999933" size=4><li>RESERVATION CANCELLATION :</font>
	<ul type=disc><font color="#CCCCCC">

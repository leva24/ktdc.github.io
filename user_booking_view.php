...
<img src="images/Equator-Bar-I.jpg" width="780" height="200"></br></br>
  ...
  $username=$_SESSION['username'];
		...
		$sql="select * from  reservation where uname='$username'  ";
...
echo"<tr><td style=color:white>".$row['id']."</td>";
			...
			?>
			<td></td>
			<td  width="60"><a href="user_booking_view.php?action=delete&id=<?php echo $id1; ?>&rooms=<?php echo $row['rooms'];?>&hid=<?php echo $row['hid']?> ">cancel</a></td>
